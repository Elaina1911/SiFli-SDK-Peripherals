...
#undef  FLASH_TABLE_MEM_TYPE
#define FLASH_TABLE_MEM_TYPE                               HAL_MEM_TYPE_NOR_FLASH
...
#undef  HCPU_FLASH_CODE_MEM_TYPE
#define HCPU_FLASH_CODE_MEM_TYPE                           HAL_MEM_TYPE_NOR_FLASH
...
#undef  DFU_FLASH_CODE_MEM_TYPE
#define DFU_FLASH_CODE_MEM_TYPE                            HAL_MEM_TYPE_NOR_FLASH
...
#undef  DFU_DOWNLOAD_REGION_MEM_TYPE
#define DFU_DOWNLOAD_REGION_MEM_TYPE                       HAL_MEM_TYPE_NOR_FLASH
...
#undef  FS_REGION_MEM_TYPE
#define FS_REGION_MEM_TYPE                                 HAL_MEM_TYPE_NOR_FLASH
...
#undef  KVDB_DFU_REGION_MEM_TYPE
#define KVDB_DFU_REGION_MEM_TYPE                           HAL_MEM_TYPE_NOR_FLASH
...
#undef  KVDB_BLE_REGION_MEM_TYPE
#define KVDB_BLE_REGION_MEM_TYPE                           HAL_MEM_TYPE_NOR_FLASH
...
#undef  PSRAM_DATA_MEM_TYPE
#define PSRAM_DATA_MEM_TYPE                                HAL_MEM_TYPE_PSRAM
